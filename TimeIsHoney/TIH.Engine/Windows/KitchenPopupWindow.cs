...
{
    public class KitchenPopupWindow
    {
        /// <summary>
        /// This class is specific to Kitchen popup window.
        /// This popup opens when the player clicks on the kitchen.
        ///
