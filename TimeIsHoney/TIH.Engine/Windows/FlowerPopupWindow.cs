...
{
    public class FlowerPopupWindow : Window
    {
        /// <summary>
        /// This class is specific to flower popup window.
        /// This popup opens when the player clicks on flowers.
        ///
